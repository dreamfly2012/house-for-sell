<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:49:"./application/admin/template/index/switch_map.htm";i:1589872173;s:77:"/www/wwwroot/fangwu.80shihua.com/application/admin/template/public/layout.htm";i:1589872182;s:77:"/www/wwwroot/fangwu.80shihua.com/application/admin/template/public/footer.htm";i:1589872182;}*/ ?>
<!doctype html>
<html>
<head>
        ...
        <dl class="row">
            ...
            <dd class="opt">
                ...
                <span id="guide_web_weapp_switch" style="<?php if(1 != $globalConfig['web_weapp_switch']): ?> display: none;<?php endif; ?>">
                    &nbsp;<a href="javascript:void(0);" data-href="<?php echo url('Weapp/index'); ?>" data-leftmenu="Weapp_index" onclick="gourl(this);">[上传管理]</a>
                </span>
            </dd>
        </dl>
        <dl class="row">
        ...
        <dl class="row">
            ...
            <dd class="opt">
                ...
                <span id="guide_web_users_switch" style="<?php if(empty($globalConfig['web_users_switch'])): ?> display: none;<?php endif; ?>">
                    &nbsp;<a href="javascript:void(0);" data-href="<?php echo url('Member/users_index'); ?>" data-leftmenu="Member_users_index" onclick="gourl(this);">[会员列表]</a>
                    &nbsp;<a href="javascript:void(0);" data-href="<?php echo url('Member/users_config'); ?>" data-leftmenu="Member_users_index" onclick="gourl(this);">[功能配置]</a>
        ...
        <dl class="row">
            ...
            <dd class="opt">
                ...
                <span id="guide_pay_open" style="<?php if(!isset($userConfig['pay_open']) || empty($userConfig['pay_open'])): ?> display: none;<?php endif; ?>">
                    &nbsp;<a href="javascript:void(0);" data-href="<?php echo url('Member/money_index'); ?>" data-leftmenu="Member_users_index" onclick="gourl(this);">[充值列表]</a>
                    &nbsp;<a href="javascript:void(0);" data-href="<?php echo url('Member/pay_set'); ?>" data-leftmenu="Member_users_index" onclick="gourl(this);">[接口配置]</a>
                </span>
            </dd>
        </dl>
        <?php endif; if($main_lang == $admin_lang): ?>
        <dl class="row">
            ...
            <dd class="opt">
                ...
                <span id="guide_shop_open" style="<?php if(!isset($userConfig['shop_open']) || empty($userConfig['shop_open'])): ?> display: none;<?php endif; ?>">
                    &nbsp;<a href="javascript:void(0);" data-href="<?php echo url('Shop/index'); ?>" data-leftmenu="Member_users_index" onclick="gourl(this);">[订单列表]</a>
                    &nbsp;<a href="javascript:void(0);" data-href="<?php echo url('Shop/conf'); ?>" data-leftmenu="Member_users_index" onclick="gourl(this);">[功能配置]</a>
        ...
        <dl class="row">
            ...
            <dd class="opt">
                ...
                <span id="guide_level_member_upgrade" style="<?php if(!isset($userConfig['level_member_upgrade']) || empty($userConfig['level_member_upgrade'])): ?> display: none;<?php endif; ?>">
                    &nbsp;<a href="javascript:void(0);" data-href="<?php echo url('Level/index'); ?>" data-leftmenu="Member_users_index" onclick="gourl(this);">[会员产品分类]</a>
                    &nbsp;<a href="javascript:void(0);" data-href="<?php echo url('Level/upgrade_index'); ?>" data-leftmenu="Member_users_index" onclick="gourl(this);">[会员业务记录]</a>
                </span>
            </dd>
        </dl>
        <?php endif; if($main_lang == $admin_lang): ?>
        <dl class="row">
            ...
            <dd class="opt">
                ...
                <span id="guide_users_open_release" style="<?php if(!isset($userConfig['users_open_release']) || empty($userConfig['users_open_release'])): ?> display: none;<?php endif; ?>">
                    &nbsp;<a href="javascript:void(0);" data-href="<?php echo url('UsersRelease/conf'); ?>" data-leftmenu="Member_users_index" onclick="gourl(this);">[功能配置]</a>
                </span>
            </dd>
        </dl>
        <?php endif; ?>
