<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:30:"./template/pc/view_product.htm";i:1649214096;s:52:"/www/wwwroot/fangwu.80shihua.com/template/pc/nav.htm";i:1649214096;s:55:"/www/wwwroot/fangwu.80shihua.com/template/pc/header.htm";i:1649214096;s:55:"/www/wwwroot/fangwu.80shihua.com/template/pc/banner.htm";i:1649214096;s:55:"/www/wwwroot/fangwu.80shihua.com/template/pc/footer.htm";i:1649214096;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
      ...
      <div class="container">
        ...
        <div class="pro_above">
          <div class="pro_image">
            <div class="pc_image">
              ...
              <?php if(is_array($eyou['field']['image_list']) || $eyou['field']['image_list'] instanceof \think\Collection || $eyou['field']['image_list'] instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = $eyou['field']['image_list'];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $mod = ($e % 2 );$i= intval($key) + 1;?>
                <li class="img_c"><i><img src="<?php echo $field['image_url']; ?>"></i></li>
              ...
              <div class="smallscroll fr">
                ...
                <div class="prev prev_det_pc"></div>
                <div class="next next_det_pc"></div>
              </div>
            </div>
            <div class="mc_image">
              <div class="swiper-container gallery-top swiper-container-horizontal swiper-container_det">
                ...
                <?php if(is_array($eyou['field']['image_list']) || $eyou['field']['image_list'] instanceof \think\Collection || $eyou['field']['image_list'] instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = $eyou['field']['image_list'];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $mod = ($e % 2 );$i= intval($key) + 1;?>
                  <div class="swiper-slide swiper-slide_det"><i><img src="<?php echo $field['image_url']; ?>"></i></div>
                <?php echo isset($field["ey_1563185380"])?$field["ey_1563185380"]:""; ?><?php echo (1 == $e && isset($field["ey_1563185376"]))?$field["ey_1563185376"]:""; ++$e; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $field = []; ?>    
                </div>
              </div>
              <div class="dot_box">
                <div class="swiper-container gallery-thumbs swiper-container-horizontal swiper-container_dot">
                  ...
                  <?php if(is_array($eyou['field']['image_list']) || $eyou['field']['image_list'] instanceof \think\Collection || $eyou['field']['image_list'] instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = $eyou['field']['image_list'];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $mod = ($e % 2 );$i= intval($key) + 1;?>
                    <div class="swiper-slide swiper-slide_dot"><i><img src="<?php echo $field['image_url']; ?>"></i></div>
                  <?php echo isset($field["ey_1563185380"])?$field["ey_1563185380"]:""; ?><?php echo (1 == $e && isset($field["ey_1563185376"]))?$field["ey_1563185376"]:""; ++$e; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $field = []; ?>   
                  </div>
                </div>
          ...
          <div class="pro_details">
            <div class="pro_title"><?php echo $eyou['field']['title']; ?> </div>
            <div class="pro_param">
              <dd class="pro_shoujia"><span>售价：</span><em><?php echo $eyou['field']['shoujia']; ?></em> 万元</dd>
              <dd class="pro_danjia"><span>单价：</span><?php echo $eyou['field']['danjia']; ?></dd>
              <dd class="pro_mianji"><span>面积：</span><?php echo $eyou['field']['mianji']; ?></dd>
              <dd class="pro_quyu"><span>区域：</span><?php echo $eyou['field']['quyu']; ?> </dd>
              <dd class="pro_xiaoqu"><span>小区名称：</span><?php echo $eyou['field']['xiaoqumingcheng']; ?></dd>
            </div>
          </div>
        </div>
        <div class="det"><span>房源详情</span></div>
