<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:55:"./application/admin/template/product/attribute_edit.htm";i:1589872181;s:77:"/www/wwwroot/fangwu.80shihua.com/application/admin/template/public/layout.htm";i:1589872182;s:77:"/www/wwwroot/fangwu.80shihua.com/application/admin/template/public/footer.htm";i:1589872182;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <form class="form-horizontal" id="post_form" action="<?php echo U('Product/attribute_edit'); ?>" method="post">
        <div class="ncap-form-default">
            ...
            <div class="bot">
                ...
                <a href="JavaScript:void(0);" onclick="check_submit('post_form','<?php echo U('Product/attribute_edit'); ?>');"  class="ncap-btn-big ncap-btn-green" id="submitBtn">确认提交</a>
        </div>
    </form>
</div>
<script type="text/javascript">
